# """Full "end-to-end" Ratter tests."""

# import pytest

# from ratter.__main__ import main, validate_arguments
...
#             "<file>": snippet("ratter_full_one.py")
#         }).get("filter_string")
#         assert filter_string == ".+"

#     def test_ratter_full_one(self, snippet, capfd):
#         main({
...
#     def test_ratter_results_one(self, snippet, capfd):
#         main({
#             "follow_imports": False,
#             "verbose": False,
#             "print_ast": False,
#             "debug": False,
#             "file": snippet("ratter_results_one.py"),
#             "filter_string": ".*",
#         })
...
#     def test_ratter_results_two(self, snippet, capfd):
#         main({
#             "follow_imports": False,
#             "verbose": False,
#             "print_ast": False,
#             "debug": False,
#             "file": snippet("ratter_results_two.py"),
#             "filter_string": ".*",
#         })
